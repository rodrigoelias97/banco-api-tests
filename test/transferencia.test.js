...
describe('Transferências', () => {
    ...
    describe('POST /transferencias', () => {
        ...
        describe('GET /transferencias{id}', () => {
            ...
            it('Deve retornar sucesso com 200 e os detalhes da transferência contido no banco de dados quando o ID for válido', async () => {
                const resposta = await request(process.env.BASE_URL)
                ...
                expect(resposta.body.conta_origem_id).to.equal(4)
        ...
        describe('GET /transferencias', () => {
            it('Deve retornar dez elementos na paginação quando informar limite de 10 registros', async () => {
                const resposta = await request(process.env.BASE_URL)
